function buildProjectPrompt(language, level, domain, focusArea) {
...
- The project must specifically challenge the student on: ${focusArea}. Design all requirements around this specific skill area.
